...
namespace dragon {
	...
	public:
		...
		static Double_t CalculateDensity(Double_t pressure, Double_t length, Int_t nmol, Double_t temp = 298.15);
		/// Calculate target density in atoms/cm^2 (with uncertainty)
		static UDouble_t CalculateDensity(UDouble_t pressure, UDouble_t length, Int_t nmol, Double_t temp = 298.15);
		/// Calculate beam energy from MD1 field
		static UDouble_t CalculateEnergy(Double_t md1, Double_t md1Err, Int_t q, Double_t m,
										 Double_t cmag = 4.815e-4, Double_t cmagErr = 0.0015*4.815e-4);
	private:
		/// Atomic mass of beam
		Double_t fBeamMass;
		/// Charge of beam
